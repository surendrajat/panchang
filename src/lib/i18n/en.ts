...
export const en = {
  ...
  'settings.timeFormat24': '{h}-hour ({eg})',
  'settings.timeFormat12': '{h}-hour ({eg} PM)',
  'settings.translit': 'Sign & planet names',
  'settings.translitOn': 'Sanskrit (Mesha, Maṅgala)',
  'settings.translitOff': 'English (Aries, Mars)',
