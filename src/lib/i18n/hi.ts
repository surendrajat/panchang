...
export const hi: Record<TranslationKey, string> = {
  ...
  'settings.timeFormat24': '{h}-घंटा ({eg})',
  'settings.timeFormat12': '{h}-घंटा ({eg} PM)',
  'settings.translit': 'राशि व ग्रह नाम',
  'settings.translitOn': 'संस्कृत (मेष, मंगल)',
  'settings.translitOff': 'अंग्रेज़ी (Aries, Mars)',
